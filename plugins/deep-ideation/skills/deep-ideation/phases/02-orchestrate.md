...
Save orchestration plan to `$WORKSPACE/02-orchestrate.md`. Return a 3-line receipt to the orchestrator per the **Return Contract** in `references/output-rules.md`.
